...
const models = [
  { slug: "qwen2.5", author: "Alibaba Qwen", category: "Chat", license: "Apache-2.0", sizes: ["0.5b", "1.5b", "7b", "14b", "32b"], description: "Multilingual LLM series with strong instruction following and 128K context.", gguf: "https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/qwen2.5-0.5b-instruct-q4_k_m.gguf" },
  { slug: "qwen2.5-coder", author: "Alibaba Qwen", category: "Code", license: "Apache-2.0", sizes: ["1.5b", "7b", "32b"], description: "Code-specialized Qwen2.5 with fill-in-the-middle support.", gguf: "https://huggingface.co/Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF/resolve/main/qwen2.5-coder-1.5b-instruct-q4_k_m.gguf" },
  { slug: "llama3.2", author: "Meta", category: "Chat", license: "Llama 3.2 Community", sizes: ["1b", "3b"], description: "Compact, on-device-friendly Llama models.", gguf: "https://huggingface.co/bartowski/Llama-3.2-1B-Instruct-GGUF/resolve/main/Llama-3.2-1B-Instruct-Q4_K_M.gguf" },
  ...
  { slug: "mistral", author: "Mistral AI", category: "Chat", license: "Apache-2.0", sizes: ["7b"], description: "Fast, efficient, fully open 7B model.", gguf: "https://huggingface.co/bartowski/Mistral-7B-Instruct-v0.3-GGUF/resolve/main/Mistral-7B-Instruct-v0.3-Q4_K_M.gguf" },
  ...
  { slug: "gemma2", author: "Google", category: "Chat", license: "Gemma", sizes: ["2b", "9b", "27b"], description: "Google's open models built from Gemini research.", gguf: "https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/resolve/main/gemma-2-2b-it-Q4_K_M.gguf" },
  ...
  { slug: "deepseek-r1", author: "DeepSeek", category: "Reasoning", license: "MIT", sizes: ["1.5b", "7b", "8b", "14b", "32b"], description: "Open reasoning model trained with reinforcement learning.", gguf: "https://huggingface.co/bartowski/DeepSeek-R1-Distill-Qwen-1.5B-GGUF/resolve/main/DeepSeek-R1-Distill-Qwen-1.5B-Q4_K_M.gguf" },
